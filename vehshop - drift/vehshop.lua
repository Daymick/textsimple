local vehshop = {
	...
	menu = {
		...
		["compacts"] = { 
			...
			name = "compacts",
			buttons = { 
				{name = "Blista", costs = 0, description = {}, model = "blista"},
				{name = "Brioso R/A", costs = 0, description = {}, model = "brioso"},
				{name = "Dilettante", costs = 0, description = {}, model = "Dilettante"},
				{name = "Issi", costs = 0, description = {}, model = "issi2"},
				{name = "Panto", costs = 0, description = {}, model = "panto"},
				{name = "Prairie", costs = 0, description = {}, model = "prairie"},
				{name = "Rhapsody", costs = 0, description = {}, model = "rhapsody"},
			}
		},
		["coupes"] = { 
			title = "coupes", 
			name = "coupes",
			buttons = { 
				{name = "Cognoscenti Cabrio", costs = 0, description = {}, model = "cogcabrio"},
				{name = "Exemplar", costs = 0, description = {}, model = "exemplar"},
				{name = "F620", costs = 0, description = {}, model = "f620"},
				{name = "Felon", costs = 0, description = {}, model = "felon"},
				{name = "Felon GT", costs = 0, description = {}, model = "felon2"},
				{name = "Jackal", costs = 0, description = {}, model = "jackal"},
				{name = "Oracle", costs = 0, description = {}, model = "oracle"},
				{name = "Oracle XS", costs = 0, description = {}, model = "oracle2"},
				{name = "Sentinel", costs = 0, description = {}, model = "sentinel"},
				{name = "Sentinel XS", costs = 0, description = {}, model = "sentinel2"},
				{name = "Windsor", costs = 0, description = {}, model = "windsor"},
				{name = "Windsor Drop", costs = 0, description = {}, model = "windsor2"},
				{name = "Zion", costs = 0, description = {}, model = "zion"},
				{name = "Zion Cabrio", costs = 0, description = {}, model = "zion2"},
			}
		},
		["sports"] = { 
			title = "sports", 
			name = "sports",
			buttons = { 
				{name = "9F", costs = 0, description = {}, model = "ninef"},
				{name = "9F Cabrio", costs = 0, description = {}, model = "ninef2"},
				{name = "Alpha", costs = 0, description = {}, model = "alpha"},
				{name = "Banshee", costs = 0, description = {}, model = "banshee"},
				{name = "Bestia GTS", costs = 0, description = {}, model = "bestiagts"},
				{name = "Blista Compact", costs = 0, description = {}, model = "blista"},
				...
				{name = "Drift Tampa", costs = 0, description = {}, model = "tampa2"},
				...
				{name = "Jester(Racecar)", costs = 0, description = {}, model = "jester2"},
		...
		["sportsclassics"] = { 
			...
			buttons = { 
				...
				{name = "JB 700", costs = 0, description = {}, model = "jb700"},
		...
		["super"] = { 
			...
			buttons = { 
				...
				{name = "ETR1", costs = 0, description = {}, model = "sheava"},
				...
				{name = "RE-7B", costs = 0, description = {}, model = "le7b"},
		...
		["muscle"] = { 
			...
			name = "muscle",
			buttons = { 
				{name = "Blade", costs = 0, description = {}, model = "blade"},
				{name = "Buccaneer", costs = 0, description = {}, model = "buccaneer"},
				{name = "Chino", costs = 0, description = {}, model = "chino"},
				{name = "Coquette BlackFin", costs = 0, description = {}, model = "coquette3"},
				{name = "Dominator", costs = 0, description = {}, model = "dominator"},
				{name = "Dukes", costs = 0, description = {}, model = "dukes"},
				{name = "Gauntlet", costs = 0, description = {}, model = "gauntlet"},
				{name = "Hotknife", costs = 0, description = {}, model = "hotknife"},
				{name = "Faction", costs = 0, description = {}, model = "faction"},
				{name = "Nightshade", costs = 0, description = {}, model = "nightshade"},
				{name = "Picador", costs = 0, description = {}, model = "picador"},
				{name = "Sabre Turbo", costs = 0, description = {}, model = "sabregt"},
				{name = "Tampa", costs =0, description = {}, model = "tampa"},
				{name = "Virgo", costs = 0, description = {}, model = "virgo"},
				{name = "Vigero", costs = 0, description = {}, model = "vigero"},
			}
		},
		["offroad"] = { 
			title = "off-road", 
			name = "off-road",
			buttons = { 
				{name = "Bifta", costs = 0, description = {}, model = "bifta"},
				{name = "Blazer", costs = 0, description = {}, model = "blazer"},
				{name = "Brawler", costs = 0, description = {}, model = "brawler"},
				{name = "Bubsta 6x6", costs = 0, description = {}, model = "dubsta3"},
				{name = "Dune Buggy", costs = 0, description = {}, model = "dune"},
				{name = "Rebel", costs = 0, description = {}, model = "rebel2"},
				{name = "Sandking", costs = 0, description = {}, model = "sandking"},
				{name = "The Liberator", costs = 0, description = {}, model = "monster"},
		...
		["suvs"] = { 
			...
			buttons = { 
				...
				{name = "Grabger", costs = 0, description = {}, model = "granger"},
				{name = "Huntley S", costs = 0, description = {}, model = "huntley"},
				{name = "Landstalker", costs = 0, description = {}, model = "landstalker"},
				{name = "Radius", costs = 0, description = {}, model = "radi"},
				{name = "Rocoto", costs = 0, description = {}, model = "rocoto"},
				{name = "Seminole", costs = 0, description = {}, model = "seminole"},
		...
		["vans"] = { 
			...
			name = "vans",
			buttons = { 
				{name = "Bison", costs = 0, description = {}, model = "bison"},
				{name = "Bobcat XL", costs = 0, description = {}, model = "bobcatxl"},
				{name = "Gang Burrito", costs = 0, description = {}, model = "gburrito"},
				{name = "Journey", costs = 0, description = {}, model = "journey"},
				{name = "Minivan", costs = 0, description = {}, model = "minivan"},
				{name = "Paradise", costs = 0, description = {}, model = "paradise"},
				{name = "Rumpo", costs = 0, description = {}, model = "rumpo"},
				{name = "Surfer", costs = 0, description = {}, model = "surfer"},
				{name = "Youga", costs = 0, description = {}, model = "youga"},
			}
		},
		["sedans"] = { 
			title = "sedans", 
			name = "sedans",
			buttons = { 
				{name = "Asea", costs = 0, description = {}, model = "asea"},
				{name = "Asterope", costs = 0, description = {}, model = "asterope"},
				...
				{name = "Fugitive", costs = 0, description = {}, model = "fugitive"},
				{name = "Glendale", costs = 0, description = {}, model = "glendale"},
				{name = "Ingot", costs = 0, description = {}, model = "ingot"},
				{name = "Intruder", costs = 0, description = {}, model = "intruder"},
				{name = "Premier", costs = 0, description = {}, model = "premier"},
				{name = "Primo", costs = 0, description = {}, model = "primo"},
				{name = "Primo Custom", costs = 0, description = {}, model = "primo2"},
				{name = "Regina", costs = 0, description = {}, model = "regina"},
				{name = "Schafter", costs = 0, description = {}, model = "schafter2"},
				{name = "Stanier", costs = 0, description = {}, model = "stanier"},
				{name = "Stratum", costs = 0, description = {}, model = "stratum"},
				{name = "Stretch", costs = 0, description = {}, model = "stretch"},
				{name = "Super Diamond", costs = 0, description = {}, model = "superd"},
				{name = "Surge", costs = 0, description = {}, model = "surge"},
				{name = "Tailgater", costs = 0, description = {}, model = "tailgater"},
				{name = "Warrener", costs = 0, description = {}, model = "warrener"},
				{name = "Washington", costs = 0, description = {}, model = "washington"},
			}
		},
		["motorcycles"] = { 
			title = "MOTORCYCLES", 
			name = "motorcycles",
			buttons = { 
				{name = "Akuma", costs = 0, description = {}, model = "AKUMA"},
				{name = "Bagger", costs = 0, description = {}, model = "bagger"},
				{name = "Bati 801", costs = 0, description = {}, model = "bati"},
				{name = "Bati 801RR", costs = 0, description = {}, model = "bati2"},
				{name = "BF400", costs = 0, description = {}, model = "bf400"},
				{name = "Carbon RS", costs = 0, description = {}, model = "carbonrs"},
				{name = "Cliffhanger", costs = 0, description = {}, model = "cliffhanger"},
				{name = "Daemon", costs = 0, description = {}, model = "daemon"},
				{name = "Double T", costs = 0, description = {}, model = "double"},
				{name = "Enduro", costs = 0, description = {}, model = "enduro"},
				{name = "Faggio", costs = 0, description = {}, model = "faggio2"},
				{name = "Gargoyle", costs = 0, description = {}, model = "gargoyle"},
				{name = "Hakuchou", costs = 0, description = {}, model = "hakuchou"},
				{name = "Hexer", costs = 0, description = {}, model = "hexer"},
				{name = "Innovation", costs = 0, description = {}, model = "innovation"},
				{name = "Lectro", costs = 0, description = {}, model = "lectro"},
				{name = "Nemesis", costs = 0, description = {}, model = "nemesis"},
				{name = "PCJ-600", costs = 0, description = {}, model = "pcj"},
				{name = "Ruffian", costs = 0, description = {}, model = "ruffian"},
				{name = "Sanchez", costs = 0, description = {}, model = "sanchez"},
				{name = "Sovereign", costs = 0, description = {}, model = "sovereign"},
				{name = "Thrust", costs = 0, description = {}, model = "thrust"},
				{name = "Vader", costs = 0, description = {}, model = "vader"},
				{name = "Vindicator", costs = 0, description = {}, model = "vindicator"},
			}
		},
	}
}
...
{entering = {2316.72,1861.58,20.7549}, inside = {-46.56327,-1097.382,25.99875, 120.1953}, outside = {-31.849,-1090.648,25.998,322.345}},
}
			...
			while #vehshop_blips > 0 do
				...
				for i,b in ipairs(vehshop_blips) do
					if IsPlayerWantedLevelGreater(GetPlayerIndex(),0) == false and vehshop.opened == false and IsPedInAnyVehicle(LocalPed(), true) == false and  GetDistanceBetweenCoords(b.pos.entering[1],b.pos.entering[2],b.pos.entering[3],GetEntityCoords(LocalPed())) < 5 then
						...
						drawTxt('Appuyez sur ~g~ENTRER~s~ pour acheter ~b~une voiture',0,1,0.5,0.8,0.6,255,255,255,255)
						currentlocation = b
						inrange = true
					end
				end
